...
class Socket implements \Artax\Observable {

    use \Artax\ObservableSubject;
    ...
    private static $RESOLUTION = 1000;

    public function __construct(Reactor $reactor, $authority) {
    ...
    private function doConnect() {
        ...
        if ($socket) {
            ...
            $error = new ConnectFailureException;
    ...
    private function initializePendingSock($socket) {
        ...
        if ($this->connectTimeout >= 0) {
            $this->timeoutWatcher = $this->reactor->once(function() {
                ...
                $this->notifyObservations(self::ERROR, $error);
                $this->stop();
            }, $this->connectTimeout * self::$RESOLUTION);
        }
    }
    ...
    private function enableSockEncryption() {
        ...
        if ($result) {
            ...
            $e = new CryptoHandshakeException;
    ...
    public function getLastDataRcvdAt() {
