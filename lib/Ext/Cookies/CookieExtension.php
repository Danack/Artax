...
class CookieExtension implements Extension {
    ...
    public function __construct(CookieJar $cookieJar = NULL, CookieParser $cookieParser = NULL) {
     ...
     *
     * @param Artax\Observable $client The client whose events we want to observe
     * @return void
     */
